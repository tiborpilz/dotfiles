...
(use-package! poly-markdown) #+end_src

** Tools
*** Copilot
For now I have my copilot completions on tab, but without this helper function,
I could not use tab for regular indenting anymore.
#+begin_src elisp
...
#+begin_src elisp
(setq lambda-theme-keyword-italic t)
...
** Modeline
*** Lambda Line
[[https://github.com/Lambda-Emacs/lambda-line][Lambda Line]] is a replacement for the Doom Emacs modeline. Although I am pretty
happy with Doom Emacs' modeline, I'm currently trying to have a more streamlined
ui in my editor, which is perfect usecase. Just like with the Lambda Themes,
this is heavily inspired by the excellent Nano theme.
