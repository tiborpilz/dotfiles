...
Also use corfu for completions in shell or eshell

# #+begin_src elisp
# (use-packag !pcmpl-args)
...
Vertico has a few extensions we can use apart from the base configuration from
Doom.
...
#+begin_src toml :tangle /usr/share/xsessions/emacs.desktop
[Desktop Entry]
Name=Emacs
